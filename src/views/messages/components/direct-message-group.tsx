...
import MessagesGroup, {
	MessageGroupProps,
} from "../../../components/message/message-group";
...
function DirectMessageActions({
	...
	const canDelete =
		isOwnMessage && message.kind === kinds.EncryptedDirectMessage;
...
function DirectMessageGroup({
	...
	const renderContent = useCallback(
		(message: NostrEvent | Rumor) => <DirectMessageContent message={message} />,
		[],
	);
