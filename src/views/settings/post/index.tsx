	...
	return (
		...
		>
			<FormControl>
				...
				<Select
					id="mediaUploadService"
					w="sm"
					{...register("mediaUploadService")}
				>
				...
				{getValues().mediaUploadService === "blossom" &&
					(!mediaServers || mediaServers.length === 0) && (
			...
			<FormControl>
				...
				<FormHelperText>
					<span>
						How much Proof of work to mine when writing notes. setting this to 0
						will disable it
					</span>
				</FormHelperText>
			</FormControl>
			...
			<FormControl>
				...
				<FormHelperText>
					Mirror all media to your personal blossom servers when sharing notes
				</FormHelperText>
			</FormControl>
			...
			<FormControl>
				<Flex alignItems="center">
					...
					<Switch
						...
						onChange={() =>
							localSettings.alwaysAuthUpload.next(
								!localSettings.alwaysAuthUpload.value,
							)
						}
					/>
				</Flex>
				<FormHelperText>
					Always authenticate with media servers when uploading media
				</FormHelperText>
			</FormControl>
		</SimpleView>
	);
