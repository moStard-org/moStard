...
function ProfileImageInput({
	...
	return (
		<FormControl>
			...
			<FormHelperText>
				Enter a URL or paste/upload an image file. You can also click the upload
				button to select a file from your device.
			</FormHelperText>
		</FormControl>
	);
}
		...
		>
			...
			<VStack spacing={4} align="stretch">
				...
				<FormControl isInvalid={!!errors.name} isRequired>
					...
					/>
					<FormHelperText>
						A nickname for your profile. It does not need to be unique so call
			...
			<VStack spacing={4} align="stretch">
				...
				<FormControl isInvalid={!!errors.nip05}>
					...
					<FormHelperText>
						...
						address. This is a verifiable identifier that proves you control a
						domain.
					</FormHelperText>
