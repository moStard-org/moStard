...
export default function ContentPoliciesSettings() {
	...
	const blurMediaOutsideSocialGraph = useObservableEagerState(
		localSettings.blurMediaOutsideSocialGraph,
	);
	const hideEmbedsOutsideSocialGraph = useObservableEagerState(
		localSettings.hideEmbedsOutsideSocialGraph,
	);
		...
		<SimpleView title="Content Policies" maxW="container.xl" gap="4">
			<Box>
				...
				<Text fontStyle="italic" color="GrayText">
					This setting will limit all content you see to your social graph. If
					your social graph is small or you want to see a global view set this
					to{" "}
			...
			<SocialGraphSlider
				...
				onChange={(value) =>
					localSettings.hideEventsOutsideSocialGraph.next(value)
				}
			...
			<SocialGraphSlider
				...
				onChange={(value) =>
					localSettings.blurMediaOutsideSocialGraph.next(value)
				}
			...
			<SocialGraphSlider
				...
				onChange={(value) =>
					localSettings.hideEmbedsOutsideSocialGraph.next(value)
				}
