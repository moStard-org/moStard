	...
	if (visible) {
		switch (event[NotificationTypeSymbol]) {
			case NotificationType.Reply:
				content = (
					<ReplyNotification event={event} onClick={onClick && handleClick} />
				);
				break;
			case NotificationType.Mention:
				content = (
					<MentionNotification event={event} onClick={onClick && handleClick} />
				);
				break;
			case NotificationType.Quote:
				content = (
					<QuoteNotification event={event} onClick={onClick && handleClick} />
				);
				break;
			...
			case NotificationType.Repost:
				content = (
					<RepostNotification event={event} onClick={onClick && handleClick} />
				);
				break;
			case NotificationType.Message:
				content = (
					<MessageNotification event={event} onClick={onClick && handleClick} />
				);
				break;
			default:
				content = (
					<UnknownNotification event={event} onClick={onClick && handleClick} />
				);
				break;
		}
	}
