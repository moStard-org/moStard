...
encode._encode = (buffers: Array<Uint8Array>, data: any) => {
	if (data == null) {
		return;
	}
...
encode.buffer = (buffers: Array<Uint8Array>, data: any) => {
	buffers.push(text2arr(data.length + ":"), data);
};

encode.string = (buffers: Array<Uint8Array>, data: any) => {
	buffers.push(text2arr(text2arr(data).byteLength + ":" + data));
};

encode.number = (buffers: Array<Uint8Array>, data: any) => {
...
encode.dict = (buffers: Array<Uint8Array>, data: any) => {
	buffers.push(buffD);
...
encode.dictMap = (buffers: Array<Uint8Array>, data: any) => {
	buffers.push(buffD);
...
encode.list = (buffers: Array<Uint8Array>, data: any) => {
	let i = 0;
	const c = data.length;
	buffers.push(buffL);
...
encode.listSet = (buffers: Array<Uint8Array>, data: any) => {
	buffers.push(buffL);
