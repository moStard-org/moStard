import { createIcon, type IconProps } from "@chakra-ui/icons";
...
import MoneroBlack from "./icons/monero-black";
...
export const MoneroBlackIcon = MoneroBlack;
export const MoneroWhiteIcon = MoneroWhite;
