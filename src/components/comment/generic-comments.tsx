...
const Comment = memo(
	({ comment, level = 0 }: { comment: NostrEvent; level?: number }) => {
				...
				<Card>
					<CardHeader px="4" py="2" display="flex" gap="2" alignItems="center">
						...
						<ButtonGroup
							...
							alignItems="center"
						>
							<EventTipButton event={comment} aria-label="Zap comment" />
